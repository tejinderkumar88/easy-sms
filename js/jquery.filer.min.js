                ...
                m = {
                    ...
                    _thumbCreator: {
                        ...
                        generateIcon: function(b) {
                            ...
                            if (b && b.type && b.type[0] && b.extension) switch (b.type[0]) {
                                case "image":
                                    c[0] = "f-image", c[1] = '<i class="far fa-file"></i>';
                                    break;
                                case "video":
                                    c[0] = "f-video", c[1] = '<i class="far fa-file"></i>';
                                    break;
                                case "audio":
                                    c[0] = "f-audio", c[1] = '<i class="far fa-file"></i>';
                                    break;
                                default:
                    ...
                    _assets: {
                        ...
                        getIcon: function(b, c) {
                            ...
                            return a.inArray(c, d) > -1 ? '<i class="far fa-file' + c + " far fa-file" + b + '"></i>' : '<i class="far fa-file far fa-file' + c + " far fa-file" + b + '"></i>'
                        },
